"""
Django settings for igor_personal_site project.
...
ROOT_URLCONF = 'igor_personal_site.urls'
WSGI_APPLICATION = 'igor_personal_site.wsgi.application'
...
WAGTAIL_SITE_NAME = "Igor Personal Site"
